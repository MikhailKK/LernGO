...
func main() {
	...
	for i := 0; i < 3; i++ {
		...
		// тут распарсиваем текст в вещественные значения, оператор оставляем текстовым, проставляем панику для ошибок (для оператора пока не работает так как он текст и паника не применяется но калькулятор не рассчитает)
		switch i {
		// операнд один
		case 0:
